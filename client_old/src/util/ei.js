const DBL_EPSILON = Number(0.0000000000000001);
const epsilon = 10.0 * DBL_EPSILON;
const DBL_MAX = Number.MAX_VALUE;

function ContinuedFractionEi(x) {
  let Am1 = 1.0;
  let A0 = 0.0;
  let Bm1 = 0.0;
  let B0 = 1.0;
...
function PowerSeriesEi(x) {
  let xn = -x;
  let Sn = -x;
  let Sm1 = 0.0;
  let hsum = 1.0;
  const g = 0.5772156649015328606065121;
  let y = 1.0;
  let factorial = 1.0;
...
function ArgumentAdditionSeriesEi(x) {
